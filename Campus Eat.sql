...
CREATE TABLE `menu` (
  ...
  `item_price` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`menu_id`)
  -- KEY `fk_F_restaurant_id` (`restaurant_id`),
  -- CONSTRAINT `fk_F_restaurant_id` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`)
) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

LOCK TABLES `menu` WRITE;
/*!40000 ALTER TABLE `menu` DISABLE KEYS */;
INSERT INTO `menu` VALUES (1,'Nuggets', 'Chicken_Nuggets',11),(2, 'Burger', 'VeggieBurger', 10),(3,'Sandwich','VegetableSandwich',9),(4, 'Burger', 'ChickenBurger', 10),(5, 'Sandwich', 'ChickenSandwich', 10),(6, 'Smoothie', 'StrawberrySmootie', 10),(7,'Smoothie', 'MangoSmootie', 9),(8, 'Rice', 'ChickenRice',7),(9,'Friedrice', 'VeggieRice',6),(10,'Dessert','ChocolateIcecream',5);
...
CREATE TABLE `food_rating` (
  `foodRating_id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11),
...
CREATE TABLE `delivery_rating` (
  `deliveryRating_id` int(11) NOT NULL AUTO_INCREMENT,
  `order_id` int(11),
  `restaurant_id` int(11),
 PRIMARY KEY (`deliveryRating_id`),
   KEY `fk_d_order_id` (`order_id`),
  KEY `fk_d_restaurant_id` (`restaurant_id`),
   CONSTRAINT `fk_d_order_id` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`),
   CONSTRAINT `fk_d_restaurant_id` FOREIGN KEY (`restaurant_id`) REFERENCES `restaurant` (`restaurant_id`)
 ) ENGINE=InnoDB AUTO_INCREMENT=206 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rating` (
  ...
  KEY `fk_order_id` (`order_id`),
  CONSTRAINT `fk_order_id` FOREIGN KEY (`order_id`) REFERENCES `menu` (`menu_id`)
...
INSERT INTO `rating` VALUES (1,4,2,'Amazing','abc.com',1);
INSERT INTO `rating` VALUES (2,3,5,'good','abc.com',2);
INSERT INTO `rating` VALUES(3,5,1,'bad','abc.com',3),(4,3,2,'okay','abc.com',4),(5,2,3,'good','abc.com',5);
INSERT INTO `rating` VALUES(6,1,4,'worst','abc.com',6),(7,5,5,'best','abc.com',7),(8,4,3,'Amazing','abc.com',8);
...
LOCK TABLES `order` WRITE;
/*!40000 ALTER TABLE `order` DISABLE KEYS */;
INSERT INTO `order` VALUES (1,1,1,1,1,1,15.63,6.63,'2021-12-04'),(2,2,2,2,2,2,18.03,9.43,'2021-12-05');
/*!40000 ALTER TABLE `order` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
desc rating;
-- INDEX
CREATE INDEX del_id  ON delivery(delivery_id);
